...
import {decode} from "../../../img-render/libs/bsorDecoder";
...
export class BeatLeaderService {
  ...
  async getScoreByPlayerIdAndMapId (playerId: string, mapId: string, option?: MapDiffOption):Promise<Leaderboard> {
  ...
  //   /api/render/beatleader/${uid}/pinnedScores
  //   if(!query['count']) {
  //     query['count'] = ["32"]
  //   }
  //   if(!query['sortBy']) {
