...
export const renderSSPlayerImg = (
  puppeteer: Puppeteer,
  ...
  return renderImg(
    puppeteer,
    <SSPlayerPage scoreUser={userInfo} leaderItems={scores} />,
    onStart,
    onError
  )
}

export const renderBLPlayerImg = (
  puppeteer: Puppeteer,
  scores: Score[],
  ...
  return renderImg(
    puppeteer,
    <BLPlayerPage user={userInfo} beatleaderItems={scores} />,
    onStart,
    onError
  )
}

export const renderBLScoreImg = (
  puppeteer: Puppeteer,
  score: Score,
  bsMap: BSMap,
  statistic: any,
