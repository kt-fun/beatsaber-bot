        ...
        >
          <div className="flex space-x-4 items-center justify-between text-xl font-bold">
            <div className="flex space-x-4 items-center justify-between text-2xl font-bold">
              <img loading={'eager'} className={"h-16 w-16 rounded-full"} src={score.player.avatar}
                   fallback={score.player.name.slice(0, 1)}/>
              <div>{score.player.name}</div>
            </div>
            <div className={'w-[100px] flex items-center justify-center flex-col'}>
              <img src={qrcodeUrl} width={80} height={80} className={'w-[80px] aspect-square'}/>
          ...
          <div className="align-end mt-auto mb-2">
            ...
            <ScoreGraph scoreId={score.id} scoreInfo={score} statistic={statistic} bsor={bsor}/>
          </div>
        </div>
