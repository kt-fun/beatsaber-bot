...
//   const res = await ctx.database.get('BeatsaverSubscribe', {
//     uid: session.userId,
...
//     const  res = await ctx.database.upsert("BeatsaverSubscribe", [{
//       "uid": session.userId,
...
//       "selfId": session.bot.selfId
//     }))
//   await ctx.database.upsert("BeatsaverSubscribe", dbData)
